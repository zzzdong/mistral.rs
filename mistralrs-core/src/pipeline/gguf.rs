    ...
    fn load_model_from_path(
        ...
        let model = match self.kind {
            ModelKind::GgufQuantized { .. } => match arch {
                ...
                GGUFArchitecture::Qwen35 => Model::Qwen3_5(QQwen3_5::try_from(model_config)?),
        ...
        let max_seq_len = match model {
            ...
            Model::Qwen3_5(ref p) => p.max_seq_len,
        ...
        let num_hidden_layers = match model {
            ...
            Model::Qwen3_5(ref model) => model.cache.normal().0.len(),
...
impl CacheManagerMixin for GGUFPipeline {
    ...
    fn cache(&self) -> &EitherCache {
        match self.model {
            ...
            Model::Qwen3_5(ref model) => &model.cache,
...
impl MetadataMixin for GGUFPipeline {
    fn device(&self) -> Device {
        match self.model {
            ...
            Model::Qwen3_5(ref model) => model.device.clone(),
